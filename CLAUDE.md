...
6. [ ] **各商材ページのAPIが正常に動作することを確認**
   - **Puppeteerを使って実際のブラウザ環境でテストすること**（クライアントサイドレンダリングのため必須）
   - トイレットペーパーページ: 商品データが取得・表示されること
   - 食器用洗剤ページ: 商品データが取得・表示されること
   - ミネラルウォーターページ: 商品データが取得・表示されること  
   - 米ページ: 商品データが取得・表示されること
